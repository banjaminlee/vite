  ...
  return (
    <div className="mt-12">
        ...
        <div className="shows">
          {list.map((data, key)=> {
            return(
              <ShowCards name={data.name} img={data.img} place={data.place} age={data.age} ticket={data.ticket} time={data.time} key={key} img_desk={data.img_desk} tooltip_text={data.tooltip} id_key={key} content_id={data.content_id}/> 
            )
          })}
        </div>
